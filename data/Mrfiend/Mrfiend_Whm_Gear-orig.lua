...
--	sets.weapons.Bunzis ={main="Bunzi's Rod",sub="Ammurapi Shield"}
	...
	WHM_AF_Hand			= "Theophany Mitts +4"  
	WHM_AF_Legs			= "Th. Pant. +3"   
	WHM_AF_Feet			= "Theo. Duckbills +3"  

	WHM_Empy_Head		= "Ebers Cap +3"      
	WHM_Empy_Body		= "Ebers Bliaut +3"   
	WHM_Empy_Hand		= "Ebers Mitts +3"      
	WHM_Empy_Legs		= "Ebers Pant. +3"   
    ...
    sets.precast.WS['Mystic Boon'] = {		
		ammo="Oshasha's Treatise",		
		head="Nyame Helm",
		neck="Rep. Plat. Medal", --"Clr. Torque +2",
		ear1="Regal Earring", --"Brutal Earring",
		ear2="Moonshade Earring",
	...
	sets.precast.WS['Hexa Strike'] = { 
		...
		ring2="Rufescent Ring", --"Epaminondas's Ring",			
		back=gear.jse_WSD,--"Toro Cape",
		waist="Fotia Belt",
		legs="Nyame Flanchard",
		feet="Nyame Sollerets"
    ...
    sets.midcast.FastRecast = {
		...
		head=WHM_Empy_Head,					
		neck="Voltsurge Torque", --"Clr. Torque +2",
		ear1="Loquac. Earring",
		ear2="Malignance Earring",
		body="Inyanga Jubbah +2",
		hands="Gende. Gages +1",					
	...
	sets.midcast.LightWeatherCure = {
		...
		sub="Clerisy Strap",				
		ammo="Pemphredo Tathlum",			
		head="Kaykaus Mitra +1", 			--WHM_Empy_Head,				 
		neck="Clr. Torque +2",
		ear1="Mendi. Earring",
	...
	sets.midcast.LightWeatherCuraga = {
		...
		body=WHM_AF_Body,						
		hands="Kaykaus Cuffs +1",					--" "Theophany Mitts +3"
	...
	sets.Self_Healing = {neck="Phalaina Locket",waist="Gishdubar Sash"}  --zurim100pt
	...
	sets.midcast['Enhancing Magic'] = {
		...
		neck="Incanter's Torque", 	--"Clr. Torque +2",				
		ear1="Mimir Earring",					
		ear2="Andoaa Earring",					
	...
	sets.midcast.Holy = {
		...
		ring1="Freke Ring",
		ring2="Metamor. Ring +1",
		back=gear.jse_MND_FC, --"Null Shawl",
		waist="Sacro Cord",
		legs="Bunzi's Pants",
		feet="Bunzi's Sabots"
		}
