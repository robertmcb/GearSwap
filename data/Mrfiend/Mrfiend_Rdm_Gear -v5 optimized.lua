...
function init_gear_sets()
	...
	sets.weapons.Crocea = {main="Crocea Mors",sub="Ammurapi Shield",range=empty} --Path C R21
	...
	sets.weapons.DualWeapons = {main="Naegling",sub="Thibron",range=empty} --TP Bonus+1000
	...
	sets.weapons.DualCrocea = {main="Crocea Mors",sub="Daybreak",range=empty} --Crocea R21 + Daybreak
	sets.weapons.DualCroceaTP = {main="Crocea Mors",sub="Thibron",range=empty} --TP Bonus+1000 sub
	...
	sets.weapons.DualMaxentiusTP = {main="Maxentius",sub="Thibron",range=empty} --TP Bonus+1000
    ...
    sets.precast.Step = {ammo="Hasty Pinion +1",
		...
		body="Malignance Tabard",hands="Malignance Gloves",left_ring="Cacoethic Ring +1", --confirmed owned R1,right_ring=Chirich_ring2,
    ...
    sets.precast.JA['Violent Flourish'] = {ammo="Regal Gem",--Or range="Ullr" but swapping to this makes you lose TP.
		...
		body="Malignance Tabard",hands=RDM_Empy_Hand,left_ring=Stikini_ring1, --FIXED: Stikini_left_ring undefined
	...
	sets.precast.FC.DT = {
		--DT FC set: maximize DT while retaining good FC. Loricate Torque confirmed owned.
		main="Sakpata's Sword",
		sub="Sacro Bulwark",
		ammo="Impatiens",
		head=RDM_AF_Head,
		neck="Loricate Torque +1", --PDT-6% confirmed owned Path A R15
		ear1="Malignance Earring",
		ear2=RDM_Empy_Ear2,
		body=RDM_Relic_Body,
		hands="Nyame Gauntlets",
		left_ring="Murky Ring",        --DT-10% Limbus
		right_ring="Lebeche Ring",
		back="Fi Follet Cape +1",
		waist="Witful Belt",           --confirmed owned
	...
	sets.precast.WS = {
		...
		ear2="Moonshade Earring", --confirmed owned: MAB+4 TP Bonus+250
		body="Nyame Mail",
	...
	sets.precast.WS['Requiescat'].CAP = sets.precast.WS['Requiescat'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Chant Du Cygne'] = {
		...
		legs="Zoar Subligar +1", --confirmed owned R10
	...
	sets.precast.WS['Evisceration'] = {
		...
		waist="Fotia Belt",
		legs="Zoar Subligar +1", --confirmed owned R10 --"Nyame Flanchard",
		feet=RDM_Empy_Feet
		}
	...
	sets.precast.WS['Evisceration'].CAP = sets.precast.WS['Evisceration'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Savage Blade'] = {
		...
		ear1="Ishvara Earring", --confirmed owned: WSD+2%
		ear2="Moonshade Earring", --confirmed owned: MAB+4 TP Bonus+250
		left_ring="Ephramad's ring",
		right_ring="Epaminondas's Ring",
		back=gear.str_wsd_jse_back,
		}
	sets.precast.WS['Savage Blade'].HighBuff = { --HIGHBUFF: attack capped
		ranged=Empty,
	...
	sets.precast.WS['Savage Blade'].CAP = sets.precast.WS['Savage Blade'].HighBuff -- legacy CAP alias		
	sets.precast.WS['Black Halo'] = {
		...
		ear1="Regal Earring", --INT+10/MND+10/MAB+7/MaAcc set bonus
		ear2="Moonshade Earring", --confirmed owned: MAB+4 TP Bonus+250
	...
	sets.precast.WS['Black Halo'].HighBuff = { --HIGHBUFF: attack capped
		ranged=Empty,
	...
	sets.precast.WS['Black Halo'].CAP = sets.precast.WS['Black Halo'].HighBuff -- legacy CAP alias
	sets.precast.WS['Sanguine Blade'] = {
			...
			feet=RDM_Empy_Feet,
			neck="Baetyl Pendant", --confirmed owned
			waist="Fotia Belt",          --WSD+10% latent TP>=1000 [V5: Orpheus=elemental dist, Fotia better for all WS]
			ear1="Malignance Earring",
			ear2="Regal Earring",
	...
	sets.precast.WS['Sanguine Blade'].CAP = sets.precast.WS['Sanguine Blade'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Seraph Blade'] = {
			...
			waist="Fotia Belt",          --WSD+10% latent TP>=1000
			ear1="Malignance Earring",
			ear2="Moonshade Earring", --confirmed owned: MAB+4 TP Bonus+250
			left_ring="Freke Ring",
			right_ring="Epaminondas's Ring",
	...
	sets.precast.WS['Seraph Blade'].HighBuff = set_combine(sets.precast.WS['Seraph Blade'], {
		...
		neck="Baetyl Pendant", --confirmed owned -- more MAB when macc confirmed
		})
	sets.precast.WS['Seraph Blade'].CAP = sets.precast.WS['Seraph Blade'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Aeolian Edge'].CAP = sets.precast.WS['Aeolian Edge'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Red Lotus Blade'].HighBuff = set_combine(sets.precast.WS['Red Lotus Blade'],{
		...
		neck="Baetyl Pendant", --confirmed owned  -- MAB > Sibyl Scarf when macc is confirmed sufficient
		})
	sets.precast.WS['Red Lotus Blade'].CAP = sets.precast.WS['Red Lotus Blade'].HighBuff -- legacy CAP alias)
	...
	sets.precast.WS['Burning Blade'].HighBuff = set_combine(sets.precast.WS['Burning Blade'],{
		-- OPTIMIZED: same logic as Red Lotus Blade - at cap swap neck for MAB
		neck="Baetyl Pendant", --confirmed owned
		})
	sets.precast.WS['Burning Blade'].CAP = sets.precast.WS['Burning Blade'].HighBuff -- legacy CAP alias)
	...
	sets.midcast.FastRecast = {
		...
		head=RDM_AF_Head,
		neck="Loricate Torque +1", --PDT-6% confirmed owned
		ear1="Malignance Earring",
		ear2=RDM_Empy_Ear2,
		body=RDM_Relic_Body,
	...
	sets.midcast.Cure = {
		...
		range=gear.empty,
		ammo="Regal Gem",
        head="Kaykaus Mitra +1", --alt: "Vanya Hood" (FC+10 Haste+2% also owned)
		neck="Incanter's Torque",
		ear1="Meili Earring",
		ear2="Mendi. Earring",
        body="Kaykaus Bliaut +1", --"Bunzi's Robe",
		hands="Kaykaus Cuffs +1", --"Gende. Gages +1",
		left_ring=Stikini_ring1, --FIXED: Stikini_left_ring undefined
    ...
    sets.midcast.LightWeatherCure = {
		...
		right_ring="Menelaus's Ring",
        back="Twilight Cape",
		waist="Hachirin-no-Obi", --NOTE: not found in inventory; using Orpheus sub
		legs=RDM_AF_Legs,
		feet="Vanya Clogs"
		}
    ...
    sets.midcast.Cure.DT = {
		--Cure.DT: confirmed Daybreak + Loricate Torque +1 both owned
		main="Daybreak",
		sub="Sacro Bulwark",
		range=gear.empty,
		ammo="Staunch Tathlum",
		head="Kaykaus Mitra +1",
		neck="Loricate Torque +1", --PDT-6% confirmed
	...
	sets.midcast.StatusRemoval = set_combine(sets.midcast.FastRecast, {main=gear.grioavolr_fc_staff,sub="Clemency Grip"}) --Grioavolr for max FC
	
	sets.midcast['Enhancing Magic'] = {
		--V5: % multipliers stack multiplicatively; flat seconds add before. Formula: (base+flat_s) x pct_mults
		--% stack: Viti.Tabard+4(15%) x Atro.Gloves+4(20%) x Leth.Houseaux+3(40%) x Embla(10%) x Ghostfyre aug(19%)
		--Flat seconds: Telchine Cap+10s, Telchine Braconi+6s, Colada aug+4s
		--Combined: (base+20s) x ~3.2 multiplier — far exceeds v4 Telchine body/hands/feet approach
		main="Colada",                 --aug: Enh dur+4s / MND+9 / MAB+17
		sub="Ammurapi Shield",
		ammo="Regal Gem",
		head=gear.telchine_enh_head,   --Telchine Cap: Enh dur+10s (flat)
		neck="Incanter's Torque",      --All magic skills+10 (Enh/Enf/Heal/Ele)
		ear1="Mimir Earring",          --Enhancing Skill+10
		ear2=RDM_Empy_Ear2,
		body=RDM_Relic_Body,           --V5 FIX: Viti.Tabard+4 Enh dur+15% >>> Telchine Chas +8s flat
		hands=RDM_AF_Hand,             --V5 FIX: Atro.Gloves+4 Enh dur+20% >>> Telchine Gloves +7s flat
		left_ring="Murky Ring",        --DT-10% / SpellInt-3%
		right_ring=Stikini_ring1,      --V5 FIX: Prolix Ring=FC only (MP+20/Enmity-3/FC), NO enh dur
		back="Ghostfyre Cape",         --aug: Enh dur+19% / Enh skill+4 / Enfb skill+7
		waist="Embla Sash",            --Enh dur+10% / FC+5%
		legs=gear.telchine_enh_legs,   --Telchine Braconi: Enh dur+6s (flat)
		feet=RDM_Empy_Feet             --V5 FIX: Leth.Houseaux+3 Enh dur+40% >>> Telchine Pigaches +9s flat
		}
	sets.midcast['Enhancing Magic'].DW = {
		main="Colada",   --restored: owned
		sub="Ammurapi Shield",}

	--Atrophy Gloves are better than Lethargy for me despite the set bonus for duration on others.
	sets.buff.ComposureOther = {
		--V5: Empy set bonus (Composure: each Empy piece = +10% dur to buffs on others)
		--% stack: Viti.Tabard(15%) x Atro.Gloves(20%) x Leth.Houseaux(40%) x Embla(10%) x Ghostfyre aug(19%)
		main="Colada",              --aug: Enh dur+4s / MND+9
		sub="Ammurapi Shield",
		ammo="Sapience Orb",
		head=RDM_Empy_Head,         --Leth.Chappel+3: DT-10% + Composure set bonus
		body=RDM_Relic_Body,        --V5 FIX: Viti.Tabard+4 Enh dur+15% (% multiplier wins)
		hands=RDM_AF_Hand,          --Atro.Gloves+4: Enh dur+20%
		legs=RDM_Empy_Legs,         --Leth.Fuseau+3: Composure set bonus
		feet=RDM_Empy_Feet,         --Leth.Houseaux+3: Enh dur+40% + Composure set bonus
		ear1="Mimir Earring",       --Enh skill+10
		ear2=RDM_Empy_Ear2,
		left_ring="Murky Ring",     --DT-10%
		right_ring=Stikini_ring1,   --V5 FIX: Prolix=FC only (NO enh dur); Stikini MND+8/MaAcc+11
		back="Ghostfyre Cape",      --aug: Enh dur+19% / Enh skill+4
		waist="Embla Sash"          --Enh dur+10% / FC+5%
		}
	...
	sets.EnhancingSkill = {
		--V5: Max Enhancing Skill for Stoneskin potency (+30 per tier above 250), Phalanx potency
		main="Pukulatmuj +1",      --Enh skill+11 / Stoneskin cast-11%
		sub="Forfend +1",          --Path A R14 sub
		ammo="Sapience Orb",
		head="Befouled Crown",
		neck="Incanter's Torque",  --All magic skills+10
		ear1="Mimir Earring",      --Enh skill+10
		ear2="Andoaa Earring",     --Enh skill+10
		body=RDM_Relic_Body,       --Viti.Tabard+4: Enh skill+24 / Enh dur+15%
		hands=RDM_Relic_Hand,      --Viti.Gloves+4: Enh skill+25
		left_ring=Stikini_ring1,
		right_ring=Stikini_ring2,
		back="Ghostfyre Cape",     --aug: Enh skill+4 / Enh dur+19%
		waist="Embla Sash",        --V5 FIX: Embla Enh dur+10% > Olympus Sash
		legs=RDM_AF_Legs,          --Atro.Tights+4: Enh skill+22
		feet=RDM_Empy_Feet         --Leth.Houseaux+3: Enh skill+35 (highest slot) / Enh dur+40%
		}

		
	sets.midcast.Refresh = {
		--Refresh potency: Amalric head + AF body/hands + Embla + Ghostfyre. Prolix confirmed owned.
		main="Crocea Mors",
		sub="Ammurapi Shield",
		ammo="Sapience Orb",
		neck="Dls. Torque +2",
		...
		ear2=RDM_Empy_Ear2,
		waist="Embla Sash",
		back="Ghostfyre Cape",     --confirmed owned: Enh skill+4 + Enh dur+19
		head="Amalric Coif +1",
		body=RDM_AF_Body,
		hands=RDM_AF_Hand,
		legs=RDM_Empy_Legs,
		feet=RDM_Empy_Feet,
		left_ring="Kishar Ring",
		right_ring=Stikini_ring1   --V5 FIX: Prolix=FC ring (MP+20/FC, NO enh dur)
		}
	...
	sets.midcast.Stoneskin = {main="Pukulatmuj +1",neck="Nodens Gorget",waist="Embla Sash",ear1="Earthcry Earring"} --V5: Gishdubar=Cure RECEIVED (wrong); Embla=Enh dur+10%
	sets.midcast.Protect = {right_ring="Sheltered Ring"}
	sets.midcast.Shell = {right_ring="Sheltered Ring"}
	sets.midcast.Regen = {main="Bolelabunga",sub="Ammurapi Shield"} --confirmed owned
	...
	sets.midcast['Enfeebling Magic'] = {
		--Base enfeebling: MND-based debuffs. Daybreak/Luminary confirmed owned.
		main="Daybreak",           --confirmed owned
		sub="Ammurapi Shield",
		range=gear.empty,
		ammo="Regal Gem",
		head=RDM_Relic_Head,       --Viti. Chapeau +4: Enf duration/MaAcc aug
		neck="Dls. Torque +2",     --confirmed owned Path A R25
		ear1="Regal Earring",      --INT+10/MND+10/CHR+10/MAB+7 + MaAcc set bonus (NO WSD)
		ear2="Snotra Earring",     --MND+8 / MaAcc+10 / Enf duration+10% [NOT Enf skill]
		body=RDM_Empy_Body,
		hands=RDM_Empy_Hand,       --Leth. Ganth +3: Enfeebling Skill
		left_ring=Stikini_ring1,   --MaAcc+9
		right_ring="Metamor. Ring +1", --MaAcc+6
		back=gear.mnd_enfeebling_jse_back, --MND+20 Haste+10 DT-5%
		waist="Luminary Sash",     --confirmed owned: MND+5 enfeeble waist
		legs=RDM_Empy_Legs,
		feet=RDM_Relic_Feet        --Viti. Boots +4: Immunobreak aug
		}
	...
	sets.precast.WS['Chant Du Cygne'].CAP = sets.precast.WS['Chant Du Cygne'].HighBuff -- legacy CAP alias)
	...
	sets.midcast.Sleep = {
		...
		ear2="Snotra Earring", --MND+8 / MaAcc+10 / Enf duration+10%
		...
		waist="Obstin. Sash",   --confirmed owned (Obstinate Sash in-game name)
		legs=RDM_Empy_Legs,
		feet=RDM_Empy_Feet
		} 
	...
	sets.midcast.Bind = {
		...
		right_ring=Stikini_ring2,--"Metamor. Ring +1",
		back=gear.int_enfeebling_jse_back, --gear.mnd_enfeebling_jse_back, "Aurist's Cape +1", --"Null Shawl",
		waist="Obstin. Sash",   --confirmed owned
		legs=RDM_Empy_Legs,
		feet=RDM_Empy_Feet
		} 
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {}) --FIXED: undefined vars removed
	...
	sets.midcast.Dispelga = set_combine(sets.midcast.Dispel, {main="Daybreak",sub="Ammurapi Shield"}) --confirmed owned
	sets.midcast.Dispelga.DW = {main="Daybreak",sub="Bunzi's Rod"} --confirmed owned
	...
	sets.midcast['Distract III'] = {
		...
		waist="Luminary Sash",   --OPTIMIZED: Luminary confirmed owned (MND+5 > Rumination for enfeebles) 
		legs="Psycloth Lappas", --confirmed owned: MaAcc+10 SIRD+15% MND+7
		feet=RDM_Relic_Feet, --RDM_Empy_Feet
		}
	...
	sets.midcast.Silence = {
		...
		waist="Luminary Sash",  --confirmed owned
		legs=RDM_Empy_Legs, --gear.chironic_macc_legs,
	...
	sets.midcast['Elemental Magic'] = {
		...
		waist="Acuity Belt +1", --INT+6 (Unity: INT+3~13) / MP+35 [INT feeds nuke MAB formula]
		legs=RDM_Empy_Legs,
		feet=RDM_Relic_Feet
		}
    ...
    sets.midcast['Elemental Magic'].Proc = {
		...
		hands="Malignance Gloves",
		left_ring="Kishar Ring",
		right_ring=Stikini_ring1,  --V5 FIX: Prolix=FC ring (no magic benefit in elemental context)
        back="Null Shawl",
		waist="Null Belt",
		legs="Malignance Tights",
...
sets.midcast.Impact = {
    ...
    sets.midcast.Drain = {
		...
		ear1="Regal Earring",
		ear2="Malignance Earring",
		body=gear.merlinic_aspir_body,   --confirmed owned: MaAcc+25 Drain+7 INT+14
		hands=gear.merlinic_aspir_hands, --confirmed owned: Drain+9
		left_ring="Evanescence Ring",
		right_ring=Stikini_ring2,
		back="Null Shawl",
		waist="Fucho-no-obi",
		legs=gear.merlinic_fc_legs,
		feet=gear.merlinic_aspir_feet    --confirmed owned: Drain+9
		}
	...
	sets.midcast.Stun = {
		...
		left_ring=Stikini_ring1,
		right_ring="Metamor. Ring +1",
		back=gear.int_enfeebling_jse_back, --INT-based Stun: INT cape better than MND
		waist="Luminary Sash",
		legs=RDM_Empy_Legs,
		feet=RDM_Empy_Feet
		}
	...
	sets.idle.MDT = {
		...
		left_ring="Defending Ring",
		right_ring="Shadow Ring",
		back="Moonlight Cape", --confirmed owned
		waist="Null Belt",
		legs="Bunzi's Pants",
		feet="Bunzi's Sabots"
		}
	...
	sets.engaged = {
			...
			hands="Malignance Gloves",
			legs="Malignance Tights",
			feet="Carmine Greaves +1", --confirmed owned: ACC+12 DEX+12 MND+20
			neck="Anu Torque",
			waist="Windbuffet Belt +1", --confirmed owned
			ear1="Sherida Earring",
			ear2="Telos Earring", --confirmed owned
	...
	sets.engaged.Acc = {ammo="Coiste Bodhar",
		head="Malignance Chapeau",neck="Null Loop",ear1="Crep. Earring",ear2="Telos Earring", --confirmed owned
	...
	sets.engaged.DT = {
			...
			ear1="Sherida Earring",
			ear2="Telos Earring", --confirmed owned --"Alabaster Earring", --"Dedition Earring", --"Eabani Earring", --"Telos Earring",
	...
	sets.engaged.DW = {
			...
			ear1="Sherida Earring",
			ear2="Telos Earring", --confirmed owned --"Eabani Earring", --"Telos Earring",
			left_ring=Chirich_ring1,
			right_ring=Chirich_ring2,
	...
	sets.engaged.DW.Acc.DT = {
			...
			ear2="Telos Earring", --confirmed owned --FIXED: was right_ear
			left_ring=Chirich_ring1,
			right_ring="Murky Ring",
			back=gear.dw_jse_back, --"Null Shawl",
		}
	...
	sets.engaged.EnspellOnly = {
		...
		right_ring=Chirich_ring2,
		back="Ghostfyre Cape",
		waist="Sailfi Belt +1", --V5: Haste+9%/TA+2% (Orpheus=elemental dist, wrong for melee TP)
		legs=RDM_Relic_Legs,
		feet="Malignance Boots"
		}
	...
	sets.engaged.EnspellOnly.Acc = {ammo="Sroda Tathlum",
		...
		body="Malignance Tabard",hands="Aya. Manopolas +2",left_ring="Cacoethic Ring +1", --confirmed owned R1,right_ring=Chirich_ring2,
	...
	sets.engaged.DualEnspellOnly = {
		...
		ear1="Sherida Earring",
		ear2="Telos Earring", --confirmed owned --"Suppanomimi",
		body="Malignance Tabard",
		hands="Aya. Manopolas +2",
		left_ring=Chirich_ring1,
		right_ring=Chirich_ring2,
		back="Null Shawl",
		waist="Reiki Yotai",    --V5: DW+7/Haste for DualEnspell (Orpheus wrong)
		legs=RDM_Relic_Legs,
		feet="Malignance Boots"
		}
	...
	sets.engaged.DualEnspellOnlyCRoc = {
		...
		right_ring=Chirich_ring2,
		back="Null Shawl",
		waist="Reiki Yotai",    --V5: DW+7 for DualEnspellCRoc
		legs=RDM_Relic_Legs,
		feet="Malignance Boots"
		}
	...
	sets.engaged.DualEnspellOnly.Acc = {ammo="Sroda Tathlum",
		head="Malignance Chapeau",neck="Null Loop",ear1="Crep. Earring",ear2="Leth. Earring +1",
		body="Malignance Tabard",hands="Aya. Manopolas +2",left_ring="Cacoethic Ring +1", --confirmed owned R1,right_ring=Chirich_ring2,
		back="Null Shawl",waist="Sailfi Belt +1",legs=RDM_Relic_Legs,feet="Malignance Boots"}
end
